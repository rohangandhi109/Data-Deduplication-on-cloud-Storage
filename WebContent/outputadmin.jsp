...
<%
    ...
    Object f=null;
    Object fs1=fs;
    Object fs2=request.getAttribute("ch");
%>
	...
	<div class = "row" style="border: 1px solid; border-radius: 10px; height: 50px; width: 96%; margin-top: 10px; margin-left: 22px;border-color:  #b2babb;">
		<div class = "col-sm-6" style = "width: 48%;">
			<input type = "hidden" class = "hiddenArea" value = "<%=fs1%>">
				<label class = "fileName" style = "margin-left: 30px; margin-top: 10px;font-family: 'Varela Round',sans-serif; letter-spacing: 0.0625em;font-weight: bold"><%=fs2%> : <%=fs1%></label>
		</div>			
	</div>
<%     
	for(i=1;i<fs+1;i++)
